...
# 🤖 ربات دانلودر در پیام رسان BALE 
...
این پروژه فقط فایلهایی که لینک مستقیم دارند را دانلود میکند مثلا انتهای آدرس شما به فرمت فایل ختم میشود اگر فایل درون پلتفرم دیگری باشد باید از دانلودرهای مخصوص آن مثل یوتیوب تلگرام و ... استفاده کنید.
...
برای مشاوره و سفارش پروژه برنامه نویسی یا آموزش برنامه نویسی از طرق زیر با ما در ارتباط باشید :‌
...
- [OllamaSetup](https://github.com/abbas-farahani/file-downloader/tree/main/downloads/OllamaSetup)
